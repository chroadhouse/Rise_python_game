...
# You can ignore a lot of the concepts in this file as you will look at them in tomorrows session
# This file is here to get you experiencing what you can do with some of the tools that you learnt about today in python
# Hopefully when you run and play around with this file, it will give you some ideas of things you could have in your game
# All of this code in this file is also perfectly good to be taken and maybe resued, 
# Hint: try and understand the presenceCheckPass and main methods
